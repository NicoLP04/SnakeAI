...
double mse(std::vector<double> yTrue, std::vector<double> yPred) {
    if (yTrue.size() != yPred.size()) {
        throw std::invalid_argument(
            "Vectors yTrue and yPred must be of the same size");
    }
...
std::vector<double> msePrime(std::vector<double> yTrue,
...
double binaryCrossEntropy(std::vector<double> yTrue,
                          std::vector<double> yPred) {
    if (yTrue.size() != yPred.size()) {
        throw std::invalid_argument(
            "Vectors yTrue and yPred must be of the same size");
...
std::vector<double> binaryCrossEntropyPrime(std::vector<double> yTrue,
                                            std::vector<double> yPred) {
    if (yTrue.size() != yPred.size()) {
        throw std::invalid_argument(
            "Vectors yTrue and yPred must be of the same size");
