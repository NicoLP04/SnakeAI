...
class Layer {
   public:
    ...
    virtual std::vector<double> backward(
        const std::vector<double>& outputGradient, double learningRate,
...
class Dense : public Layer {
   public:
    ...
    std::vector<double> backward(const std::vector<double>& outputGradient,
                                 double learningRate, double beta1 = 0.9,
                                 double beta2 = 0.999,
                                 double epsilon = 1e-8) override;
